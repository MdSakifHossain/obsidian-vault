...
the default value for the `installer install` will be the command dir. and if i set something like: `./installer install -y` to directly install the script. and uninstall will do it to do what it has.
